        ...
        <div style={{position:"relative",top:"-100vh"}}>
          ...
          {show_applications==true&&
            <div style={{backgroundColor:"rgb(15,15,15)",width:"45%",height:"57%",animation:"apps_animation 800ms ease-in 0s 1 alternate forwards",position:"relative",left:"100vw",top:"200px",position:"fixed",zIndex:"102",borderRadius:"16px",cursor:"default"}} ref={apps_ui_ref}>
              ...
              <div style={{backgroundImage:"linear-gradient(90deg, rgb(77,156,240) 0%,rgb(13, 95, 184) 40%,rgba(6, 35, 65, 1) 100%)",WebkitBackgroundClip:"text",backgroundClip:"text",WebkitTextFillColor:"transparent",display:"inline-block",textDecoration:"underline",marginLeft:"10px",marginTop:"30px"}} onClick={()=>{window.location.href = "/generate_media"}}>Generate Media</div>
